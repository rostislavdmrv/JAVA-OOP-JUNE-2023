...
public class Pizza {
    ...
    public Pizza(String name, int numberOfToppings) {
        ...
        this.numberOfToppings = numberOfToppings; // така се прави зада може стойността на numberOfToppingsда се промени
        // ,защото setToppings връща не броя а new ArrayList<>
    }
